...
private static final boolean ANYADIR_A_FIC_LOG = true;
	...
	public clsAltaMareomotriz() 
	{
		...
		lblDistancia = new JLabel("        Distancia al pueblo:        ");
		lblDistancia.setAlignmentX(Component.CENTER_ALIGNMENT);
		panelizda.add(lblDistancia);
		
		txtDistancia = new JTextField();
		txtDistancia.setAlignmentX(Component.CENTER_ALIGNMENT);
		panelizda.add(txtDistancia);
	...
	private void Registrar()
	{
		...
		{		
				...
				try {
					objGestor.CrearMaquinaMareomotriz(txtNombre.getText(), txtColor.getText(), Double.parseDouble(txtValor.getText()), txtFabricante.getText(), String.valueOf(txtEstado.getSelectedItem()), txtNombrePueblo.getText(), Double.parseDouble(txtDistancia.getText()));
					dispose();
